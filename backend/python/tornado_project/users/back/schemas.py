...
definitions = {'definitions': {'RegUser': {'type': 'object', 'properties': {'username': {'type': 'string'}, 'email': {'type': 'string'}}}, 'User': {'type': 'object', 'properties': {'username': {'type': 'string'}, 'reg_date': {'type': 'string', 'format': 'date'}, 'short_info': {'type': 'string'}, 'avatar': {'type': 'string', 'description': 'Image url'}}}}, 'parameters': {}}

validators = {
    ('user', 'POST'): {'json': {'$ref': '#/definitions/RegUser'}},
    ...
    ('user_verifyEmail_username', 'GET'): {'args': {'required': ['secret'], 'properties': {'secret': {'type': 'string', 'description': 'Secret param'}}}},
    ('u_username', 'PUT'): {'form': {'required': [], 'properties': {'short_info': {'required': False, 'type': 'string'}, 'avatar': {'type': 'file', 'required': False, 'description': 'Avatar image file (jpg/png)'}}}},
}

filters = {
    ('user', 'POST'): {200: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
    ...
    ('user_logout', 'GET'): {},
    ('user_verifyEmail_username', 'GET'): {200: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
    ('u_username', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/User'}}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('u_username', 'PUT'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/User'}}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}
